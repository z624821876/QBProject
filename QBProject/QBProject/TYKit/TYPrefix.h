...
#define iPhone6Plus ([UIScreen mainScreen].bounds.size.width == 414 && [UIScreen mainScreen].bounds.size.height == 736)
...
#define resizeHeight(h) kScreenW / 375 * h
...
#define RGBCOLORSAME(a) [UIColor colorWithRed:(a)/255.0f green:(a)/255.0f blue:(a)/255.0f alpha:1]
